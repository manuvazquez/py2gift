...
__all__ = ['Question', 'NumericalQuestion', 'MultipleChoiceQuestion', 'MultipleChoiceTheoreticalQuestion']
...
class MultipleChoiceTheoreticalQuestion(MultipleChoiceQuestion):
